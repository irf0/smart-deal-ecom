...
const inputCls =
  "w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:border-gray-900";
...
export default function AdminCouponsPage() {
  ...
  async function handleSave() {
    ...
    if (!form.valid_from || !form.valid_until)
      return setFormError("Both date fields are required.");
    if (new Date(form.valid_from) >= new Date(form.valid_until))
      return setFormError("Valid From must be before Valid Until.");
    if (form.discount_percent < 1 || form.discount_percent > 20)
      return setFormError("Discount must be between 1% and 20%.");
    ...
    try {
      await saveCoupon(payload, editTarget?.id ?? null);
      closeModal();
      await fetchCoupons();
    } catch (err) {
      setFormError(
            ...
            <tbody>
              {coupons.map((c) => (
                ...
                >
                  ...
                  <td className="px-4 py-3 text-gray-700">
                    {fmtINR(c.min_cart_value)}
                  </td>
                  <td className="px-4 py-3 text-gray-700">
                    {fmtINR(c.max_discount_amount)}
                  </td>
                  <td className="px-4 py-3 text-gray-700">
                  ...
                  <td className="px-4 py-3">
                    ...
                    >
                      <span
                        className={`absolute top-0.5 left-0.5 w-4 h-4 bg-white rounded-full shadow transition-transform ${c.active ? "translate-x-4" : "translate-x-0"}`}
                      />
                    </button>
                  </td>
                  <td className="px-4 py-3">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="col-span-2">
                ...
                <p className="text-xs text-gray-400 mt-1">
                  Auto-uppercased. Share this with customers.
                </p>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setField("discount_percent", e.target.value, "number")
                  }
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setField("min_cart_value", e.target.value, "number")
                  }
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setField("max_discount_amount", e.target.value, "number")
                  }
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setField("usage_limit", e.target.value, "number")
                  }
                />
              </div>
            ...
            <div className="flex justify-end gap-3 mt-6">
              ...
              <button
                onClick={handleSave}
                disabled={saving}
                className="px-4 py-2 text-sm font-semibold bg-gray-900 text-white rounded-lg hover:bg-gray-700 disabled:opacity-50 transition-colors"
              >
                {saving
                  ? "Saving…"
                  : editTarget
        ...
        >
          ...
          >
            ...
            <p className="text-sm text-gray-600 leading-relaxed">
              ...
              Orders that already used this coupon are unaffected.
            </p>
            <div className="flex justify-end gap-3 mt-6">
              <button
                onClick={() => setDeleteTarget(null)}
