  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <Button
          asChild
          className="px-4 py-4 bg-gray-900 text-white text-sm font-semibold rounded-lg hover:bg-gray-700 transition-colors cursor-pointer"
        >
          ...
          <tbody className="divide-y">
            {products?.map((product) => {
              ...
              const totalStock = variants.reduce(
                (acc: number, v: any) => acc + v.stock_count,
                0,
              );
              ...
              return (
                <tr key={product.id} className="hover:bg-gray-50">
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-3">
                      {thumbnail ? (
                        ...
                        <div className="w-10 h-10 bg-gray-100 rounded border flex items-center justify-center text-gray-400 text-xs">
                          No img
                        </div>
                      )}
                      <div>
                  ...
                  <td className="px-4 py-3">
                    <span
                      className={`font-medium ${totalStock === 0 ? "text-red-500" : "text-gray-700"}`}
                    >
                      {totalStock}
                    </span>
                  </td>
